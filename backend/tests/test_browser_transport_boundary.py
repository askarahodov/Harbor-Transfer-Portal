...
def test_compose_uses_bridge_network_with_frontend_only_host_publication() -> None:
...
def test_frontend_listener_and_api_proxy_use_internal_service_discovery() -> None:
