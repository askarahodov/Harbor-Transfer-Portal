...
class Operation(TimestampMixin, Base):
    ...
    harbor_profile_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    harbor_profile_name: Mapped[str | None] = mapped_column(String(128), nullable=True)
    harbor_profile_url: Mapped[str | None] = mapped_column(String(2048), nullable=True)
    ...
    handoff_filename: Mapped[str | None] = mapped_column(String(192), nullable=True)
    handoff_sha256: Mapped[str | None] = mapped_column(String(64), nullable=True)
    handoff_size_bytes: Mapped[int | None] = mapped_column(Integer, nullable=True)
