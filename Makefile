...
.PHONY: help up down logs fmt lint lint-backend test test-backend test-frontend test-ci-scope docs-check migrate build compose-config smoke-compose check-foundation
