...
<style scoped>
.project-create { margin-top: var(--space-4); padding: var(--space-4); border: 1px solid var(--color-warning-text); border-radius: var(--radius-md); background: var(--color-warning-surface); }
...
.project-create__item input { min-height: 40px; border: 1px solid var(--color-border-control); border-radius: var(--radius-md); padding: 0 var(--space-3); background: var(--color-surface); color: var(--color-text); font: inherit; }
.project-create__operator-note { margin-top: var(--space-3); color: var(--color-text); }
.project-create__operator-note p { margin: 0; }
.project-create__error { margin: var(--space-3) 0 0; color: var(--color-danger-text); }
