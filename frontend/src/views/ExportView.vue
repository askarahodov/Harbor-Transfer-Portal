...
.stepper__item--active { border-color: var(--color-bridge-blue); color: var(--color-text); box-shadow: var(--shadow-sm); }
...
.icon-button { min-width: 42px; min-height: 42px; display: grid; place-items: center; border: 1px solid var(--color-border-control); border-radius: var(--radius-md); background: var(--color-surface); color: var(--color-text); cursor: pointer; }
