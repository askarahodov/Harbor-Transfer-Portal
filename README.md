...
**Не разработчик?** Начните с [паспорта проекта](docs/project-passport.md): там простым языком описаны назначение портала, роли пользователей, SOURCE/TARGET, типовой сценарий передачи, безопасность и текущая готовность v1.
